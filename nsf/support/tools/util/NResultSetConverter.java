...
public class NResultSetConverter {
	...
	/**
	 * ResultSet에 담겨있는 정보를 NData형으로 변환한다. 숫자의 경우 DB column의 Number 길이에 따라 int 혹은
	...
	/**
	 * ResultSet에 담겨있는 정보를 NMultiData형으로 변환한다. 숫자의 경우 DB column의 Number 길이에 따라
	...
	/**
	 * ResultSet에 담겨있는 정보를 Entity로 변환한다. 변환시 Entity의 set함수를 이용하여 변수에 값을 저장한다.
	 * 
	 * @param rs
	...
	/**
	 * ResultSet에 담겨있는 정보를 Entity의 ArrayList로 변환한다. 변환시 Entity의 set함수를 이용하여 변수에
	 ...
	 * @param methodName
	 *            함수명
	 * @return method method명을 통하여 취득한 함수
	 */
	...
	// 아래 함수는 Value Object의 속성들을 public으로 지정한 경우 사용하실수 있습니다.(비권장)
	/**
